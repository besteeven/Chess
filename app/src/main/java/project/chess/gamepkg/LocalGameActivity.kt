                ...
                Box {
                    Column {
                        ...
                        Row(
                            ...
                            Text(
                                "Blanc : ${whiteTime / 60}:${(whiteTime % 60).toString().padStart(2, '0')}",
                                fontSize = 18.sp
                            )
                            Text(
                                "Noir : ${blackTime / 60}:${(blackTime % 60).toString().padStart(2, '0')}",
                                fontSize = 18.sp
                            )
                        }
                        ChessBoardUI(
